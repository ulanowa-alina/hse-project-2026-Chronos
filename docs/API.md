...
2. [[#Входные параметры]]<br>
   2.1. [[#Endpoints]]<br>
   2.2. [[#Модели]]<br>
   2.3. [[#Ограничения и проверки параметров]]
3. [[#Выходные параметры]]<br>
   3.1. [[#Положительный ответ]]<br>
   3.2. [[#Ответ с ошибками]]
...
**Описание изменений** - текстовое описание изменений документa
...
| Код | Описание                       | Виды                                                                    |
| --- | ------------------------------ | ----------------------------------------------------------------------- |
| 400 | Ошибки входных данных          | VALIDATION_ERROR<br> INVALID_FORMAT<br> MISSING_FIELD                   |
